...
function _yCounts(createyCount){return(
createyCount()
)}
...
function _createyCount(years,data){return(
function createyCount() {
  var yCounts = [];
...
export default function define(runtime, observer) {
  ...
  main.variable(observer("yCounts")).define("yCounts", ["createyCount"], _yCounts);
  main.variable(observer("years")).define("years", ["data"], _years);
  main.variable(observer("createyCount")).define("createyCount", ["years","data"], _createyCount);
